      ...
      <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
        @if (Route::has('login'))
            <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                ...
                @else
                    <a href="{{ route('login') }}" class="text-sm text-gray-700 underline btn btn-success" style="color:#fff;font-size: 22px;">Log in</a>

                    @if (Route::has('register'))
                        <a href="{{ route('register') }}" class="ml-4 text-sm text-gray-700 underline btn btn-primary" style="color:#fff;
                        margin-left: 113px;
                        font-size: 22px;">Register</a>
                    @endif
                @endauth
            </div>
        @endif

     <h1 style="color:#fff">welcome to home تحت الانشاء</h1>
      <div class="subscribe">
